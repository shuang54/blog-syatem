<template>
  <div class="container" id="container">
      ...
      <div class="nav">
        ...
        <div class="nav-item">
          <div class="category-nav" id="category">
            <ul>
              <li v-for="(item, index) in webSiteJson" :key="item.Category_id"
                :class="item.Category_id == Category_id ? 'active' : ''">
                <a @click="goAnchor(item.Category_id)">
    ...
    <div class="main" id="mainWrap">
      <div id="mainContent">
        <!-- 每个大item -->
        <div v-for="(item, index) in webSiteJson" :key="item.Category_id" class="fe" :id="item.Category_id">
          <!-- 标题 -->
          ...
          <div>
            <!--  每个item -->
            <a v-for="(smallItem, index) in item.item_children" :key="index" target="_blank" :href="smallItem.a_href">
              <div class="item">
                <div class="logo">
                  <img width="100%" class="loaded" alt="图片未显示"
                    v-lazy="`https://api.iowen.cn/favicon/get.php?url=` + smallItem.a_href">
                  {{ smallItem.child_name }}
                </div>

                <div class="desc">
                  {{ smallItem.child_desc }}
                </div>
              </div>
            </a>
          </div>
      ...
      webSiteJson: [
        ...
        },
        {
          ...
          "item_children": [
            ...
            },
            {
              ...
              "img_src": "./img/vue_meta_info.png",
              "a_href": "https://github.com/muwoo/vue-meta-info",
              "child_desc": "vue-meta-info是一个基于vue 2.0的插件，它会让你更好的管理你的app里面的meta信息设置vue，支持SSR"
            },
            {
              "child_name": "vue-simple-uploader",
              "img_src": "./img/vue_simple_uploader.png",
        ...
        },
        {
          ...
          "item_children": [
            ...
            {
              "child_name": "uni-app",
              "img_src": "./img/uniapp.png",
              "a_href": "https://uniapp.dcloud.io/",
              "child_desc": "uni-app 是一个使用 Vue.js 开发所有前端应用的框架，开发者编写一套代码，可编译到iOS、Android、H5、以及各种小程序等多个平台。"
            },
            {
              "child_name": "WeUI",
        ...
        },
        {
          ...
          "item_children": [
            ...
            {
              "child_name": "YAPI",
              "img_src": "./img/yapi.png",
              "a_href": "http://yapi.demo.qunar.com",
              "child_desc": "YApi 是高效、易用、功能强大的 api 管理平台，旨在为开发、产品、测试人员提供更优雅的接口管理服务。"
            },
            {
              "child_name": "云配色",
        ...
        },
        {
          ...
          "item_children": [
            ...
            {
              "child_name": "虫部落快搜",
              "img_src": "./img/chongbuluo.png",
              "a_href": "https://search.chongbuluo.com/",
              "child_desc": "快搜！虫部落全网独家首发出品！为你聚合Google,百度,必应等国内外综合搜索和学术,资源,专业领域知识等垂直搜索。精准搜索,便捷交互！是你的网络搜索第一站！"
            },
            {
              "child_name": "Photopea",
              "img_src": "./img/photopea.png",
              "a_href": "https://www.photopea.com/",
              "child_desc": "免安装的网页版“ps完美替代者”——Photopea，走红国外！"
            },
            {
              "child_name": "万能命令",
              "img_src": "./img/wnrun.png",
              "a_href": "https://wn.run/cn/",
              "child_desc": "wn万能命令是一个在线工具效率平台，将各种高质量的在线工具按应用站点聚合起来，让你以方便快捷好记的方式寻找和使用各类在线工具。"
            },
            {
              "child_name": "临时邮箱",
              "img_src": "./img/24mail.png",
              "a_href": "http://24mail.chacuo.net/",
              "child_desc": "填写邮箱时候，不想使用您的真实邮箱？那就使用24mail.chacuo.net 临时邮箱。不需要注册，邮箱持续24小时，比十分钟邮箱（10分钟)保持时间更长，可以任意设置邮箱名，随时更换邮箱。"
            },
            {
              "child_name": "临时短信",
              "img_src": "./img/pdflibr.png",
              "a_href": "https://www.pdflibr.com/",
              "child_desc": "在线接收短信，接收短信验证码，显示迅速，与国外类似短信验证码接收更快捷。"
            },
            {
              "child_name": "Firefox Send",
              "img_src": "./img/firefoxSend.png",
        ...
        },
        {
          ...
          "item_children": [
            ...
            {
              "child_name": "科塔学术导航",
              "img_src": "./img/sciping.png",
              "a_href": "https://site.sciping.com/",
              "child_desc": "科塔学术导航-致力于成为国内领先的科研与学术资源导航平台，为科研人员提供科研网站导航，网址库等服务，让科研工作更简单、更有效率。"
            },
            {
              "child_name": "Awesome-Windows",
              "img_src": "./img/AwesomeWindows.png",
              "a_href": "https://github.com/Awesome-Windows/Awesome/blob/master/README-cn.md",
              "child_desc": "Windows上优质&amp;精选的最佳应用程序及工具列表。"
            },
            {
              "child_name": "异星软件空间",
              "img_src": "./img/yxbsh.png",
              "a_href": "http://yx.bsh.me/",
              "child_desc": "给您提供精彩感受的软件博客！推荐精选好用实用的软件及资源，且有详细的图文评测介绍。大量绿色、好用软件及资源下载。"
            },
            {
              "child_name": "大数据导航",
              "img_src": "./img/199it.png",
              "a_href": "http://hao.199it.com/",
              "child_desc": "大数据导航，以大数据产业为主，大数据工具为辅，给用户提供一个更加快速找到大数据相关的工具平台。"
            },
            {
              "child_name": "今日热榜",
              "img_src": "./img/tophub.png",
              "a_href": "https://tophub.today/",
              "child_desc": "今日热榜提供各站热点聚合：微信、今日头条、百度、知乎、V2EX、微博、贴吧、豆瓣、天涯、虎扑、Github、华尔街见闻...全网新闻热点排行榜服务。"
            },
            {
              "child_name": "全历史",
              "img_src": "./img/allhistory.png",
              "a_href": "https://www.allhistory.com/",
              "child_desc": "全历史(Allhistory）以AI知识图谱为核心引擎，通过高度时空化、关联化数据的方式构造及展现数字人文内容，尤其是历史知识。让用户沉浸在纵横开阔、左图右史的（历史、人文、社科等）知识海洋中。"
            }
          ]
        },
        {
          ...
          "item_children": [
            ...
            {
              "child_name": "Cmder",
              "img_src": "./img/cmder.png",
              "a_href": "https://cmder.net/",
              "child_desc": "cmder是一个增强型命令工具，通过它可以使用Windows下的所有命令，可以使你像操作Linux一样操作Windows，是一个值得我们拥有的高逼格软件。"
            },
            {
              "child_name": "马克鳗",
...
@media (min-width:481px) {
  ...
  .container .left-bar .nav .category-nav,
  ...
  .container .left-bar .nav li:hover {
    cursor: pointer
  }

  .container .left-bar .nav li.active a,
  .container .left-bar .nav li.active i,
  .container .left-bar .nav li:hover a,
  .container .left-bar .nav li:hover i {
    color: #fff
  }
